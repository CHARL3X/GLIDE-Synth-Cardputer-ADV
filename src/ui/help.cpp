...
const Line kLines[] = {
    ...
    {"w..p start UNIQUE to YOUR device -", false},
    {"rolled from its seed at first boot.", false},
    {"q is GLIDE, the home/boot sound.", false},
    ...
    {"* by a name = your own sound (made or", false},
    {"saved), not the stock factory voice.", false},
    ...
    {"Re-roll bank: nine brand-new slots", false},
    {"(w..p); q stays GLIDE. New instrument.", false},
