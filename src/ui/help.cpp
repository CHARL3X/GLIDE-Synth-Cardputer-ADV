...
const Line kLines[] = {
    ...
    {"SOUNDS (hold fn)", true},
    {"fn + number row : the 10 live knobs", false},
    {"  then [ ] fine, - = coarse", false},
    {"fn + q..p       : pick a sound (10)", false},
    {"fn + shift + q..p : SAVE over that slot", false},
    ...
    {"SOUND DESIGN (settings > SOUND)", true},
    {"Init sound  : blank slate to build on", false},
    {"Randomize   : a surprise starting point", false},
    {"Sound reset : back to the factory voice", false},
    {"Filter mode : low/high/band/notch", false},

    {"SAVING", true},
    {"fn+shift+q..p saves the whole sound", false},
    {"(mods, filter, FX). Saves survive a", false},
    {"reboot and firmware updates - they are", false},
    {"never wiped. Headphones: just plug in.", false},
};
