...
const Line kLines[] = {
    ...
    {"CREATE > ROLL gives a new one (hear it", false},
    {"instantly), EVOLVE changes it, Undo", false},
    ...
    {"ROLL (\x11 key): a whole new patch in", false},
    {"one tap; it auditions instantly. Roll", false},
    {"till you love one.", false},
    {"EVOLVE (\x10 key): change THIS sound a", false},
    {"little or a lot (Evolve amt). Sculpt.", false},
